import type { TextAlignment } from "./text_alignment.ts";
...
export interface FieldBlock {
  ...
  // If the text does not fit on the specified number of lines, any remaining text is drawn over the
  // previous text on the last line.
  // Any number between 1 and 9,999 may be used. The default value is 1.
  MaxLines: number;

  // Extra spacing to add between lines, in dots.
  // Positive numbers increase the distance between lines, negative numbers decrease the distance.
